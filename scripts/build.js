 ...
 *                    && npm run build:website -w @kylebrodeur/page-agent-website
 *                    && npm run zip -w @kylebrodeur/page-agent-ext
 *
 * 1. cleanup
...
tasks.push(
	{
		label: '@kylebrodeur/page-agent-website',
		command: 'npm run build:website',
		cwd: join(rootDir, 'packages/website'),
	},
	{
		label: '@kylebrodeur/page-agent-ext',
		command: 'npm run zip',
