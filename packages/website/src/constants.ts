...
export const CDN_DEMO_URL =
	'https://cdn.jsdelivr.net/npm/@kylebrodeur/page-agent@1.11.0/dist/iife/page-agent.demo.js'
export const CDN_DEMO_CN_URL =
	'https://registry.npmmirror.com/@kylebrodeur/page-agent/1.11.0/files/dist/iife/page-agent.demo.js'
